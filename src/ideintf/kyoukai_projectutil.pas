...
uses
  Forms, Dialogs, Controls, LazIDEIntf,
  Classes, SysUtils, ProjectIntf, IDEMsgIntf, NewItemIntf, PackageIntf;

resourcestring
  rs_Project_Name = 'Create A New Kyoukai Application';
  rs_Project_Description = 'Create a new web project using Kyoukai Framworks';
...
uses kyoukai_projectconsts, KyfrmNewProject;
